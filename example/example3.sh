...
echo "================================================================================"
echo "PanDelos plus plus example3"
echo -e
echo "In this example you can analyze up to 16 mycoplasma genitalium genomes with amino acid sequences"
...
[ ! -d "../pandelos_output/example3" ] && mkdir ../pandelos_output/example3
